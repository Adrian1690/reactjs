...
var PokeApp = (function (_React$Component) {
	...
	function PokeApp(props) {
		...
		this.pokemons = [{ number: 1, name: 'Bulbasaur', years: 15 }, { number: 2, name: 'Ivysaur', years: 20 }, { number: 3, name: 'VenuSaur', years: 25 }];
	}
...
var PokeRow = (function (_React$Component) {
	...
	_createClass(PokeRow, [{
		...
		value: function onClick(ev) {
			//cada ves 	ue clickemos en los <li> pokeavatar
